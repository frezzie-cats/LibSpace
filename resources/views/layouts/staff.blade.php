...
<head>
    ...
    <!-- Font Awesome CDN (for icons like user, sign-out) -->
...
<body class="font-sans antialiased bg-gray-100">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <nav x-data="{ open: false, dropdownOpen: false }" class="bg-gray-800 border-b border-gray-700 shadow-lg">
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <div class="ml-3 relative">
                            <button @click="dropdownOpen = ! dropdownOpen" class="flex items-center text-sm font-medium text-gray-400 hover:text-white hover:border-gray-300 focus:outline-none focus:text-white focus:border-gray-300 transition duration-150 ease-in-out">
