...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Add New Facility</h2>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
        <form action="{{ route('staff.facilities.store') }}" method="POST">
            ...
            <button type="submit" class="px-6 py-3 bg-green-600 text-white font-medium rounded-lg shadow-md hover:bg-green-700 transition duration-150">Create Facility</button>
        </form>
    </div>
@endsection